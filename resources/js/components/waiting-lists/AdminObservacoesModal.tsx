...
export default function AdminObservacoesModal({ open, selected, form, setForm, onClose }: AdminObservacoesModalProps) {
                ...
                >
                    ...
                    <label className="block">
                        ...
                        >
                            ...
                            <option value="nao_quer_operar">Quer ser operado mais tarde</option>
